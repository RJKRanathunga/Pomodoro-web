...
export default function Home() {
  ...
  const [shouldStartTimer, setShouldStartTimer] = useState(false); // New state to control timer start
          ...
          <div className="main-container">
            ...
            <div className="timer">
              ...
              <div className="controls">
                <button id="startButton" className="start-button" data-active={isActive.toString()} onClick={isActive ? pauseTimer : startTimer}>
